...
// function Faq (config: Partial<ChatoperaOptions> | Partial<ChatoperaOptions>[]) {
//   log.verbose('WechatyChatopera', 'Faq(%s)', JSON.stringify(config))

//   const normalizedConfigList: ChatoperaOptions[] = []
...
//     log.verbose('WechatyChatopera', 'FaqExtension(vorpal)')
...
// const faqAction = (configList : ChatoperaOptions[]) => {
//   log.verbose('WechatyChatopera', 'Faq() faqAction("%s")', JSON.stringify(configList))
...
//     args: Args
//   ): Promise<void> {
//     log.verbose('WechatyChatopera', 'Faq() faqAction() faqActionExecutor("%s")', JSON.stringify(args))
...
//     log.verbose('WechatyChatopera', 'Faq() faqAction() faqActionExecutor() found %s answers', searchResultList.length)
